...
public class RmFashionApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		categoriaFemininoRepository.saveAll(Arrays.asList(catfem1, catfem2, catfem3, catfem4, catfem5, catfem6, catfem7,
				catfem8, catfem9, catfem10));

		// PRODUTO FEMININO CALÇAS
		ProdutoFeminino prodFemCalca1 = new ProdutoFeminino(null, "CALÇA JEANS JOGGER LISA CURVE & PLUS SIZE", "48",
				"AZUL", 159.90);
		ProdutoFeminino prodFemCalca2 = new ProdutoFeminino(null, "CALÇA JEANS SKINNY COM PUÍDOS CURVE & PLUS SIZE",
				"46", "AZUL", 139.90);
		ProdutoFeminino prodFemCalca3 = new ProdutoFeminino(null, "CALÇA JEANS SKINNY MARMORIZADA CURVE & PLUS SIZE",
				"46", "AZUL", 139.90);

		// PRODUTO FEMININO BERMUDAS E SHORTS
		ProdutoFeminino prodFemBermShort1 = new ProdutoFeminino(null, "SHORT METALIZADO FIT RUNNER", "P", "CINZA",
				79.90);
		ProdutoFeminino prodFemBermShort2 = new ProdutoFeminino(null,
				"SHORT CLOCHARD ESTAMPADO COM CINTO CURVE & PLUS SIZE", "46", "PRETO", 99.90);
		ProdutoFeminino prodFemBermShort3 = new ProdutoFeminino(null, "SHORT JEANS BOYFRIEND COM FAIXA", "36", "BRANCO",
				79.90);

		// PRODUTO FEMININO CAMISAS
		ProdutoFeminino prodFemCamisa1 = new ProdutoFeminino(null, "CAMISA COM BOTÕES E NÓ", "M", "BRANCO", 99.90);
		ProdutoFeminino prodFemCamisa2 = new ProdutoFeminino(null, "CAMISA ESTAMPADA MANGA CURTA", "M", "VERDE",
				119.90);
		ProdutoFeminino prodFemCamisa3 = new ProdutoFeminino(null, "CAMISA COM DETALHE EM LAISE", "M", "BRANCO",
				139.90);

		// PRODUTO FEMININO BLUSAS E CAMISETAS
		ProdutoFeminino prodFemBlusaCamiseta1 = new ProdutoFeminino(null,
				"CAMISETA ESPORTIVA MANGA CURTA ESTAMPA IMPOSSIBLE", "M", "ROSA", 49.90);
		ProdutoFeminino prodFemBlusaCamiseta2 = new ProdutoFeminino(null, "REGATA ESPORTIVA NADADOR EM CREPE", "M",
				"LARANJA", 29.90);
		ProdutoFeminino prodFemBlusaCamiseta3 = new ProdutoFeminino(null, "REGATA ESPORTIVA NADADOR EM CREPE", "M",
				"PRETO", 29.90);

		// PRODUTO FEMININO MODA PRAIA FEMININO
		ProdutoFeminino prodFemModaPraia1 = new ProdutoFeminino(null, "BIQUÍNI TOP CROPPED ESTAMPA LISTRADA NEON", "M",
				"preto", 39.90);
		ProdutoFeminino prodFemModaPraia2 = new ProdutoFeminino(null,
				"BIQUÍNI CALCINHA HOT PANTS ESTAMPE LISTRADA NEON", "M", "PRETO", 39.90);
		ProdutoFeminino prodFemModaPraia3 = new ProdutoFeminino(null, "BIQUÍNI CALCINHA TEXTURIZADO NEON", "M",
				"AMARELO", 59.90);
		...
		ProdutoFeminino prodFemVestido1 = new ProdutoFeminino(null, "VESTIDO ESTAMPADO COM BORBOLETAS", "M", "AMARELO",
				159.90);
		ProdutoFeminino prodFemVestido2 = new ProdutoFeminino(null, "VESTIDO MIDI COM BOTÕES EM LINHO", "M", "BRANCO",
				199.90);
		ProdutoFeminino prodFemVestido3 = new ProdutoFeminino(null, "VESTIDO COMBINAÇÃO COM DETALHE EM RENDA", "M",
				"OFF-WHITE", 49.90);

		// PRODUTO FEMININO SAIAS
		ProdutoFeminino prodFemSaia1 = new ProdutoFeminino(null, "SAIA MIDI LISA COM CINTO CURVE & PLUS SIZE", "G",
				"BEGE", 159.90);
		ProdutoFeminino prodFemSaia2 = new ProdutoFeminino(null, "SAIA EM LINHO COM BOTÕES CURVE & PLUS SIZE", "G",
				"AZUL", 119.90);
		...
		ProdutoFeminino prodFemJens1 = new ProdutoFeminino(null, "JAQUETA JEANS CONFORT CURVE & PLUS SIZE", "G", "AZUL",
				179.90);
		ProdutoFeminino prodFemJens2 = new ProdutoFeminino(null, "CALÇA JEANS JOGGER LISA CURVE & PLUS SIZE", "48",
				"AZUL", 159.90);
		ProdutoFeminino prodFemJens3 = new ProdutoFeminino(null, "SHORT JEANS BOYFRIEND COM FAIXA", "38", "BRANCO",
				79.90);

		// PRODUTO FEMININO ESPORTIVO
		ProdutoFeminino prodFemEsportivo1 = new ProdutoFeminino(null, "TOP ESPORTIVO COM BOJO E SEM COSTURA LISO", "M",
				"ROSA", 39.90);
		ProdutoFeminino prodFemEsportivo2 = new ProdutoFeminino(null, "CAMISETA MANGA CURTA ESPORTIVA COM AMARRAÇÃO",
				"M", "ROXO", 59.90);
		...
		catfem4.getProdutosFeminino()
				.addAll(Arrays.asList(prodFemBlusaCamiseta1, prodFemBlusaCamiseta2, prodFemBlusaCamiseta3));
		...
		produtoFemininoRepository.saveAll(Arrays.asList(prodFemCalca1, prodFemCalca2, prodFemCalca3, prodFemBermShort1,
				prodFemBermShort2, prodFemBermShort3, prodFemCamisa1, prodFemCamisa2, prodFemCamisa3,
				prodFemBlusaCamiseta1, prodFemBlusaCamiseta2, prodFemBlusaCamiseta3, prodFemModaPraia1,
				prodFemModaPraia2, prodFemModaPraia3, prodFemModaIntima1, prodFemModaIntima2, prodFemModaIntima3,
				prodFemVestido1, prodFemVestido2, prodFemVestido3, prodFemSaia1, prodFemSaia2, prodFemSaia3,
				prodFemJens1, prodFemJens2, prodFemJens3, prodFemEsportivo1, prodFemEsportivo2, prodFemEsportivo3));
		...
		ProdutoMasculino prodMascBermudaShort1 = new ProdutoMasculino(null, "BERMUDA ESTAMPA FLORAL COM AMARRAÇÃO", "M",
				"ROXO", 69.90);
		ProdutoMasculino prodMascBermudaShort2 = new ProdutoMasculino(null, "BERMUDA ESTAMPA FLORAL COM AMARRAÇÃO", "M",
				"AZUL", 69.90);
		ProdutoMasculino prodMascBermudaShort3 = new ProdutoMasculino(null, "BERMUDA LISTRADA COM AMARRAÇÃO", "M",
				"BRANCO", 79.90);
		...
		ProdutoMasculino prodMascCamisa1 = new ProdutoMasculino(null, "CAMISA MANGA CURTA ESTAMPA FLORAL COM FRUTAS",
				"M", "BRANCO", 79.90);
		ProdutoMasculino prodMascCamisa2 = new ProdutoMasculino(null, "CAMISA ESTAMPADA EM TRICOLINE", "M", "PRETO",
				79.90);
		...
		ProdutoMasculino prodMascModaIntima1 = new ProdutoMasculino(null, "CUECA BOXER LISTRAS VERDES E BRANCAS", "M",
				"PRETO", 25.90);
		ProdutoMasculino prodMascModaIntima2 = new ProdutoMasculino(null, "CUECA BOXER POLIAMIDA SEM COSTURA DUOMO",
				"M", "VERMELHO", 29.90);

		// PRODUTO MASCULONO JEANS MASCULINO
		ProdutoMasculino prodMascJeans1 = new ProdutoMasculino(null, "BERMUDA JEANS SUPER DESTROYED", "M", "BRANCO",
				99.90);
		ProdutoMasculino prodMascJeans2 = new ProdutoMasculino(null, "CALÇA JEANS", "40", "AZUL", 119.90);

		// PRODUTO MASCULINO POLOS
		ProdutoMasculino prodMascPolo1 = new ProdutoMasculino(null, "CAMISA POLO COM LISTRAS NAS MANGAS", "M",
				"VERMELHO", 99.90);
		ProdutoMasculino prodMascPolo2 = new ProdutoMasculino(null, "CAMISA POLO COM LISTRAS NAS MANGAS", "M", "BRANCO",
				99.90);

		// PRODUTO MASCULINO REGATAS
		ProdutoMasculino prodMascRegata1 = new ProdutoMasculino(null, "REGATA COM RECORTE LISTRADA", "M", "MULTICORES",
				39.90);
		ProdutoMasculino prodMascRegata2 = new ProdutoMasculino(null,
				"REGATA ESTAMPA URSO DA CALIFORNIA CÍRCULO SOLARIS", "M", "BRANCO", 29.90);
		...
		catmasc1.getProdutosMasculino()
				.addAll(Arrays.asList(prodMascBermudaShort1, prodMascBermudaShort2, prodMascBermudaShort3));
		...
		produtoMasculinoRepository.saveAll(Arrays.asList(prodMascBermudaShort1, prodMascBermudaShort2,
				prodMascBermudaShort3, prodMascCalca1, prodMascCalca2, prodMascCalca3, prodMascCamisa1, prodMascCamisa2,
				prodMascCamiseta1, prodMascCamiseta2, prodMascModaIntima1, prodMascModaIntima2, prodMascJeans1,
				prodMascJeans2, prodMascPolo1, prodMascPolo2, prodMascRegata1, prodMascRegata2, prodMascEsport1,
				prodMascEsport2, prodMascPraia1, prodMascPraia2));
		...
		catSex1.getSexShop()
				.addAll(Arrays.asList(sexComestico1, sexComestico2, sexComestico3, sexComestico4, sexComestico5,
						sexComestico6, sexComestico7, sexComestico8, sexComestico9, sexComestico10, sexComestico11,
						sexComestico12, sexComestico13, sexComestico14, sexComestico15, sexComestico16, sexComestico17,
						sexComestico18, sexComestico19));
		...
		produtoSexShopRepository.saveAll(Arrays.asList(sexComestico1, sexComestico2, sexComestico3, sexComestico4,
				sexComestico5, sexComestico6, sexComestico7, sexComestico8, sexComestico9, sexComestico10,
				sexComestico11, sexComestico12, sexComestico13, sexComestico14, sexComestico15, sexComestico16,
				sexComestico17, sexComestico18, sexComestico19, sexAcess1, sexAcess2, sexAcess3, sexAcess4, sexAcess5,
				sexAcess6, sexComest1, sexAneis1, sexAneis2));
		...
		Cliente cliente1 = new Cliente(null, "Rafael Souza", "rafael-game1@hotmail.com", "41162983019", "205726604",
				data.parse("02/02/2000"), TipoCliente.PESSOAFISICA);
		cliente1.getTelefones().addAll(Arrays.asList("3250-6020", "3245-7026"));

		Cliente cliente2 = new Cliente(null, "Rafael Java", "rafael-game2@hotmail.com", "05031676060", "112201155",
				null, TipoCliente.PESSOAFISICA);
		cliente2.getTelefones().addAll(Arrays.asList("4250-6070", "3129-2010"));

		Cliente cliente3 = new Cliente(null, "Luiz Felipe", "rafael-game22@hotmail.com", "57669255000169", "478956939",
				null, TipoCliente.PESSOAJURIDICA);
		cliente3.getTelefones().addAll(Arrays.asList("8560-4075"));

		Cliente cliente4 = new Cliente(null, "Alex", "rafael-game14@hotmail.com", "58582087039", "278409908", null,
				TipoCliente.PESSOAFISICA);
		cliente4.getTelefones().addAll(Arrays.asList("3159-7023"));

		Cliente cliente5 = new Cliente(null, "Gabriela", "rafael-game12@hotmail.com", "99467488000", "133990643", null,
				TipoCliente.PESSOAFISICA);
		cliente5.getTelefones().addAll(Arrays.asList("98527-3010"));

		Cliente cliente6 = new Cliente(null, "Maria Silva", "rafael-game13@hotmail.com", "99914768067", "467160144",
				null, TipoCliente.PESSOAFISICA);
		cliente6.getTelefones().addAll(Arrays.asList("98510-9090"));

		Cliente cliente7 = new Cliente(null, "Paulo Felipe", "rafael-game5@hotmail.com", "56932563000172", "205726604",
				null, TipoCliente.PESSOAJURIDICA);
		cliente7.getTelefones().addAll(Arrays.asList("3260-9080", "98570-3010"));

		// -----CRIANDO OS ENDEREÇOS------

		Endereco endereco1 = new Endereco(null, "Av. 13 de Maio", "7210", "Altos", "Bemfica", "6000000", cliente1,
				cidade1);
		Endereco endereco2 = new Endereco(null, "Rua São Luís", "751", null, "Alto da Brasília", "6000420", cliente2,
				cidade2);
		Endereco endereco3 = new Endereco(null, "Rua Aracaju", "500", null, "Acaracuzinho", "6000700", cliente3,
				cidade3);
		Endereco endereco4 = new Endereco(null, "Rua da Coleirinha", "200", "3° Andar", "palma", "600400", cliente4,
				cidade4);
		Endereco endereco5 = new Endereco(null, "Avenida Vaticano", "3510", null, "Alemanha", "65085-255", cliente5,
				cidade5);
		Endereco endereco6 = new Endereco(null, "Rua Lagoa do Bonfim", "1000", null, "Alecrim", "59129-620", cliente6,
				cidade6);
		Endereco endereco7 = new Endereco(null, "Rua Nelson Ferreira", "4222", null, "Jardim Nossa Senhora Aparecida",
				"42580-90", cliente7, cidade7);
		Endereco endereco8 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "42570-90", cliente7,
				cidade7);
		...
		Pagamento pagt2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, pedido2, sdf.parse("10/12/2019 00:00"),
				null);
		pedido2.setPagamento(pagt2);

		Pagamento pagt3 = new PagamentoComBoleto(null, EstadoPagamento.QUITADO, pedido3, sdf.parse("06/12/2019 08:00"),
				sdf.parse("06/12/2019 12:00"));
		pedido3.setPagamento(pagt3);

		Pagamento pagt4 = new PagamentoComBoleto(null, EstadoPagamento.CANCELADO, pedido4,
				sdf.parse("06/12/2019 10:00"), null);
		...
		Pagamento pagt6 = new PagamentoComBoleto(null, EstadoPagamento.QUITADO, pedido6, sdf.parse("05/12/2019 15:20"),
				sdf.parse("06/12/2019 11:30"));
